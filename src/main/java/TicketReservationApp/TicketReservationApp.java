 ...
 */
    public class TicketReservationApp {
        ...
        private static void start() {
            ...
            int select; //çıkış için 0 ı seçiniz.
            do {
                ...
                boolean isReserved=!bus.getSeats().contains(seat); // true ise rezerve edilmiş
                ...
                if (km>0 && age>0 && (type==1 || type==2)&& !isReserved){
                    ...
                    System.out.println("Sayın  "+name+" , Geçersiz giriş yaptınız!");
                }}
